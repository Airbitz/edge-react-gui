...
export type NavigationProp<Name: $Keys<ParamList>> = {
  // Information:
  // canGoBack: () => boolean, // Not in router-flux
  isFocused: () => boolean,
  state: mixed, // Switch to dangerouslyGetState in react-navigation
  ...
  // Things we don't have types for yet:
  // addListener: mixed,
  // dangerouslyGetParent: mixed,
  // dangerouslyGetState: mixed, // Not in router-flux
  // dispatch: mixed,
  // removeListener: mixed, // Not in router-flux
  // reset: mixed,
  // setOptions: mixed, // Not in router-flux
}
